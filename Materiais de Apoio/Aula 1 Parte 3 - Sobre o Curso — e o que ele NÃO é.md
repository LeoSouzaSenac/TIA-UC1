...
A carga horária total do curso é de 1.200 horas, distribuídas em 17 Unidades Curriculares (UCs) e 3 Projetos Integradores, organizados em 3 módulos progressivos. O curso foi autorizado pelo Conselho Regional do Senac em 27 de novembro de 2024, e é classificado como curso experimental.

Os requisitos de acesso ao curso são: idade mínima de 16 anos e ter concluído (ou estar cursando) o segundo ano do Ensino Médio, além de conhecimento básico prévio em operação de sistemas operacionais.
...
- Um curso sobre "como usar o ChatGPT no dia a dia";
- Um curso de engenharia de prompt (a técnica de escrever comandos eficientes para ferramentas de IA Generativa);
- Um curso de "ferramentas de Inteligência Artificial para produtividade" no ambiente de trabalho.
...
Isso inclui o desenvolvimento de competências em:

- Arquitetura de computadores e hardware, incluindo o funcionamento de GPUs;
- Programação real, utilizando a linguagem Python;
- Matemática e estatística aplicadas à Inteligência Artificial;
- Banco de dados relacionais e não relacionais;
- Computação em nuvem (Cloud Computing) e Big Data;
- Machine Learning, o motor por trás de qualquer sistema de Inteligência Artificial;
- Redes Neurais Artificiais e Deep Learning;
- Processamento de Linguagem Natural;
- Visão Computacional;
- Ética e responsabilidade no desenvolvimento de soluções de Inteligência Artificial.

Ao final do curso, o aluno será capaz, entre outras competências formalmente previstas no perfil profissional de conclusão do curso: reconhecer e interpretar modelos de arquitetura de computadores; elaborar códigos em Python para aplicações de Inteligência Artificial; compreender e aplicar funções matemáticas e estatísticas necessárias para Machine Learning; selecionar e estruturar bancos de dados adequados a cada aplicação; implementar sistemas de computação em nuvem distribuída; desenvolver e treinar arquiteturas de Redes Neurais Artificiais; programar e avaliar modelos de Deep Learning; aplicar técnicas de Processamento de Linguagem Natural; e desenvolver algoritmos de detecção e reconhecimento de objetos em imagens e vídeos, entre outras.
...
- UC1 — Reconhecer Modelos de Arquitetura de Computadores e GPU (64 horas): estudo da arquitetura de computadores, diferenças entre CPU e GPU, processos e threads, fundamentos de redes de computadores e de sistemas operacionais Linux. É o assunto do quarto material deste conjunto, e da nossa primeira aula prática.
...
- UC13 — Desenvolver Redes Neurais Artificiais (80 horas): arquiteturas de redes neurais, funções de ativação, algoritmos de treinamento e otimização.
- UC14 — Aplicar Deep Learning para Criar Soluções de Inteligência Artificial (100 horas): redes neurais convolucionais, redes neurais recorrentes, redes adversariais generativas e frameworks como TensorFlow e PyTorch.
- UC15 — Utilizar Processamento de Linguagem Natural nos Casos de Uso para Inteligência Artificial (120 horas): fundamentos linguísticos, ferramentas como spaCy e NLTK, técnicas de pré-processamento de texto e aplicações práticas.
- UC16 — Aplicar Visão Computacional para Soluções em Inteligência Artificial (100 horas): pré-processamento de imagens, detecção e reconhecimento de objetos, segmentação e rastreamento.
- UC17 — Projeto Integrador Assistente de Desenvolvimento em Inteligência Artificial (40 horas): projeto final, normalmente envolvendo a combinação de múltiplas técnicas (por exemplo, Visão Computacional e Processamento de Linguagem Natural) para resolver um problema real.
...
Cada Projeto Integrador segue três etapas formais:

1. Problematização: definição e detalhamento do problema a ser resolvido;
...
Para cada indicador de competência dentro de uma Unidade Curricular, o aluno recebe, durante o processo, uma das seguintes menções: Atendido, Parcialmente Atendido ou Não Atendido. Ao final da Unidade Curricular, a menção final para cada indicador é Atendido ou Não Atendido. Se todos os indicadores forem atendidos, a Unidade Curricular recebe a menção Desenvolvida; caso contrário, recebe Não Desenvolvida, o que significa reprovação naquela Unidade Curricular específica.

Para ser aprovado no curso como um todo, o aluno precisa atingir a menção Desenvolvida em absolutamente todas as Unidades Curriculares (incluindo os Projetos Integradores), além de manter frequência mínima de 75%, conforme legislação vigente.

Caso o aluno apresente dificuldades ao longo do processo, existe recuperação imediata, por meio de estudos dirigidos, resolução de situações-problema e outras estratégias de aprendizagem voltadas a sanar a dificuldade específica identificada.
