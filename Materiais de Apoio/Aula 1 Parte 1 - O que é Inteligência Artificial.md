...
## 1. A definição de Inteligência Artificial
...
Essa distinção importa porque a cultura popular (filmes, séries, notícias sensacionalistas) associa IA a máquinas que "pensam" ou "sentem". Tecnicamente, isso não existe hoje. O que existe é matemática aplicada em grande escala, como veremos a seguir.

---

## 2. Por que Inteligência Artificial não é mágica

Este é talvez o ponto mais importante deste primeiro material, e o mito mais necessário de ser desfeito logo no início do curso.
...
## 3. Programação tradicional versus Machine Learning
...
### 3.2 Machine Learning (Aprendizado de Máquina)
...
Termos técnicos importantes aqui:
...
## 4. Os três tipos de Aprendizado de Máquina
...
No aprendizado supervisionado, cada exemplo do conjunto de dados já vem acompanhado da resposta correta. Por exemplo: uma foto de gato, junto com a etiqueta (ou label, no termo técnico em inglês) "gato". O sistema aprende comparando sua própria previsão com a resposta correta fornecida, e ajustando-se para errar cada vez menos.
...
É importante destacar, desde já, que o ChatGPT e sistemas semelhantes são uma aplicação específica de Deep Learning — não são sinônimo do campo inteiro de Inteligência Artificial. Esse ponto será retomado com mais profundidade na seção 10 deste material.
...
## 9. A Inteligência Artificial já está no seu dia a dia
...
## 10. Inteligência Artificial Generativa não é sinônimo de Inteligência Artificial
...
## 11. Mapa geral da Inteligência Artificial
...
## 12. Glossário de termos técnicos usados neste material
...
Este material corresponde à Parte 1 da aula de abertura do curso. O próximo material (2/4) trata do mercado de trabalho em Inteligência Artificial.
